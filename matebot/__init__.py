...
class bot():
  ...
  def log(self, reply):
    try:
      ...
      print(log_str.debug(u'Grupo de admin incorreto ou mal configurado. Mensagem de erro ao tentar enviar erro ao grupo de admin: %s\n\nLog que seria mandado para o grupo de admin:\n%s' %s (e, reply)))
